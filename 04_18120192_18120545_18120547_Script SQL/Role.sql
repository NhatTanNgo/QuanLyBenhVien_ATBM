...
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO NV_KETOAN;
...
GRANT SELECT ON NHANVIEN TO NV_TAIVU;
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO NV_TAIVU;
GRANT SELECT ON PHIEUCHAMCONG TO NV_TAIVU;
...
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO NV_QL_CHUYENMON;
...
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO NV_QL_TAIVU;
...
GRANT SELECT ON NHANVIEN TO NV_BANTHUOC;
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO NV_BANTHUOC;
...
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO BACSI;
...
GRANT EXECUTE ON INSERT_PKB TO BACSI;
...
GRANT SELECT ON PHIEUCHAMCONG TO TIEPTAN_DIEUPHOI;
GRANT SELECT ON NHANVIEN TO TIEPTAN_DIEUPHOI;
GRANT UPDATE (HoTen, SDT, DiaChi,Email, DOB) on NHANVIEN TO TIEPTAN_DIEUPHOI;
